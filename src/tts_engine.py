"""
IRIS TTS Engine v3.0 - Эмоциональный голос с Edge TTS
...
class TTSEngine:
    ...
    def __init__(self, 
        ...
        """
        print("[TTS] Инициализация эмоционального движка Ирис v3.0...")
    ...
    def _process_queue(self):
        ...
        while self.is_running:
            try:
                priority, counter, (text, emotion) = self.message_queue.get(timeout=0.2)
    ...
    def speak(self, text: str, emotion: str = 'neutral', priority: bool = False):
        ...
        Args:
            ...
            emotion: Эмоциональная окраска (neutral, happy, excited, gentle, supportive, tense, sad, sarcastic, proud, encouraging)
...
if __name__ == "__main__":
    print("=== Тест эмоционального TTS Ирис v3.0 ===\n")
    
    try:
        tts = TTSEngine(voice='ru_female_soft', volume=0.8)
        tts.start()
