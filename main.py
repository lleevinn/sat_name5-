...
try:
    ...
    print("[IRIS] Voice input недоступен")
...
try:
    ...
    print("[IRIS] Визуальный модуль недоступен")

try:
    from src.iris_core.brain import IrisBrain
    BRAIN_AVAILABLE = True
except ImportError:
    BRAIN_AVAILABLE = False
    print("[IRIS] Brain модуль недоступен")
...
class IrisAssistant:
    ...
    def __init__(self):
        ...
        self.CONFIG = {
            ...
            "voice_mode": "hybrid",  # auto, vosk, google, hybrid, simple
        }
    ...
    def process_voice_command(self, command: str):
        ...
        if 'привет' in command_lower:
            ...
            try:
                response = self.iris_brain.chatwithuser(command)
                if response:
                    emotion = 'neutral'
                else:
